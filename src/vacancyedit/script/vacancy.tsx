export class Vacancy{
    ...
    static init(){
        ...
        var del_buttons : NodeListOf<HTMLButtonElement> = document.querySelectorAll("button.del");
        var form : any = document.getElementById("vacancy") as HTMLFormElement;
        ...
        for(var i = 0; i < buttons.length; i++){
            ...
            (button as HTMLButtonElement).onclick = function(e){
                addInputRow(e, this);
            }
        }
        ...
        function addInputRow(e : any , that : any){
            e.preventDefault();
                ...
                if (xhr.readyState == 4){
                    if (xhr.status == 200) {
                        ...
                        for(var i = 0; i < btn_close.length; i++){
                            var btn : HTMLButtonElement = btn_close[i];
        ...
        function checkArrayInputs(that : any){
